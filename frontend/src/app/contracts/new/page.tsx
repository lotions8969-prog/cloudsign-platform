      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        {step === 3 && (
          <div className="card p-8 space-y-6">
            ...
            {(isDemoConfigured() || getDemoSession()) && (
              <div className="bg-gray-100 border border-gray-300 rounded-lg p-4 text-sm text-gray-600 flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 flex-shrink-0 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                </svg>
                <span>
                  <strong>デモモード:</strong> 書類はブラウザ内に保存されます。メールは実際には送信されません。SendGrid設定後に実際の送信が可能になります。
                </span>
              </div>
            )}
