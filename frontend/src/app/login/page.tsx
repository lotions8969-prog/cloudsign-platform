      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg px-4 py-2.5 text-gray-700 font-medium hover:bg-gray-50 transition-colors mb-4"
          >
...
function getJaErrorMessage(msg: string): string {
  ...
  if (msg.includes("wrong-password")) return "パスワードが間違っています";
